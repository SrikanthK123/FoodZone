...
import { Recipes, MainDishesItems } from './RecipesData'
  ...
  return (
    ...
    <div class="container "  style={{marginTop:'50px'}}>
     <div className='TextVeg' style={{display:'flex',justifyContent:'center'}}>
      <h2 className='p-3 text-white mt-5' style={{backgroundColor:'#ff8585',color:'#ffebeb',borderRadius:'10px',boxShadow:'rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px',}}>Main Dishes</h2>
      </div>
      <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
      {
        MainDishesItems.map((item,index)=>(
          <div class="col" >
